        ...
        for i in range(n):
            ...
            if row[4] >= confidence:
                ...
                if self.class_to_label(labels[i]) == 'person':
                    ...
                    feature = 'person'
                    detection.append(( [x1, y1, int(x2-x1), int(y2-y1)], row[4].item(), 'person'))
...
print("Deteecto is called")
import os
os.environ["KMP_DUPLICATE_LIB_OK"]="TRUE"
from deep_sort_realtime.deepsort_tracker import DeepSort
object_tracker = DeepSort(max_age=2,
                            n_init=1,
                            nms_max_overlap=1.0,
...
while cap.isOpened():
    ...
    tracks = object_tracker.update_tracks(detections, frame=img)  #[left,top,w,h]
